...
<head>
	...
	<title>Konvensi Inovasi INTI</title>
	<!-- Tell the browser to be responsive to screen width -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="icon" href="<?php echo base_url(); ?>assets/adminLTE3/images/Logo-Konvensi-Inovasi-INTI-2021.png">
...
<div class="login-box">
	<div class="login-logo">
		<img src="<?php echo base_url('assets/images/Logo-Konvensi-Inovasi-INTI-2022-01-putih.png') ; ?>" alt="konvensi inovasi inti" class="img-fluid mb-2" width="180">
	</div>
	<!-- /.login-logo -->
	<div class="card">
		<div class="card-body login-card-body">
			<p class="login-box-msg"><?php echo $page_title; ?></p>
			<p>
				Email dengan instruksi untuk membuat kata sandi baru telah dikirimkan kepada Anda.
			</p>
		</div>
		<!-- /.login-card-body -->
	</div>
