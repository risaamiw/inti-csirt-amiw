...
<section class="" style="width:100%; height: 600px;">
    <div class="container" style="background-color: #150544; width:970px; height:500px; border-top-right-radius: 40px; margin-right:35px;">
        <h2 style="border-style: solid; width:31%; padding: 20px; border-radius:20px; color:white; margin-left:100px; margin-top:35px;">Alamat Pelaporan</h2>
        ...
        <h4 style="color: white; font-family:poppins; margin: right 50%; margin-left:432px; margin-top:-420px;">Laporan Insiden Keamanan Siber Dapat Dikirimkan Melalui</h4>
        <br><br>
        <p style="color: white; font-family:poppins; margin: right 50%; margin-left:432px;">EMAIL<br></p>
        <h3 style="color: white; font-family:poppins; margin: right 50%; margin-left:440px;">csirt[at]inti.co.id</h3>
        <br>
        <p style="color: white; font-family:poppins; margin: right 50%; margin-left:432px;">TELEPHONE<br></p>
        <h3 style="color: white; font-family:poppins; margin: right 50%; margin-left:440px;">(022) 5201-501</h3>
    </div>
</section>
